...
<div id="content">
					<div class="index">
            <img src="http://socdnw.speedgabia.com/template/asset/images/company/top_menu_img_3.png" alt="법인/단체 프로그램을 알아보세요!">
					</div>
					...
					<div class="box">
						...
						<div id="company1" class="content">
							<h3><img src="http://socdnw.speedgabia.com/template/asset/images/company/txt4.gif" alt="쏘카 법인/단체 프로그램"></h3>
							<p class="txt"><img src="http://socdnw.speedgabia.com/template/asset/images/company/txt5.gif" alt="쏘카 법인/단체 프로그램은 1인 이상의 기업, 정부기관, 비영리단체를 대상으로 진행하는 특별 프로그램입니다. 쏘카는 법인/단체의 비용 절감 및 간편한 이용을 통해 업무 효율성을 높이는 등 최상의 업무 차량 지원을 제공합니다."></p>
							<div><a href="/join"><img alt="법인/단체 회원가입" src="http://socdnw.speedgabia.com/template/asset/images/company/btn_company_mail_n.gif"></a><a href="https://www.dropbox.com/sh/nbmi016ck6bihl9/AAC1mnZNR3-vqe5ww6tcxZr1a?dl=0" target="_blank" style="margin-left:10px;"><img alt="법인 프로그램안내서 다운로드" src="http://socdnw.speedgabia.com/template/asset/images/company/btn_company.gif"></a></div>
							...
							<div class="box_program">
								<ul class="list_program">
									<li>
										<strong><img src="http://socdnw.speedgabia.com/template/asset/images/company/txt6.gif" alt="임직원 업무 효율 증대"></strong>
										<ul>
										...
										<div class="box_img">
											<img src="http://socdnw.speedgabia.com/template/asset/images/company/img1.gif" alt="">
										</div>
									</li>
									<li class="r">
										<strong><img src="http://socdnw.speedgabia.com/template/asset/images/company/txt7.gif" alt="비용 절감"></strong>
										<ul>
										...
										<div class="box_img">
											<img src="http://socdnw.speedgabia.com/template/asset/images/company/img2.gif" alt="">
										</div>
									</li>
								</ul>
								<ul class="list_program">
									<li>
										<strong><img src="http://socdnw.speedgabia.com/template/asset/images/company/txt8.gif" alt="차량이용 관리 부담 해소"></strong>
										<ul>
											<li>온라인으로 구성원 관리 및 사용내역 확인 가능</li>
											<li>차량 이용에 따른 비용 매니지먼트 가능</li>
										</ul>
										<div class="box_img">
											<img src="http://socdnw.speedgabia.com/template/asset/images/company/img3.gif" alt="">
										</div>
									</li>
									<li class="r">
										<strong><img src="http://socdnw.speedgabia.com/template/asset/images/company/txt9_new.gif" alt="친환경 차량 공급"></strong>
										<ul>
											<li>경형 및 하이브리드 차량 제공</li>
											<li>서울시내 공영주차장 주차비 50% 감면</li>
										</ul>
										<div class="box_img">
											<img src="http://socdnw.speedgabia.com/template/asset/images/company/img4.gif" alt="">
										</div>
									</li>
								</ul>
							</div>
							<h4><img src="http://socdnw.speedgabia.com/template/asset/images/company/txt10_n.gif" alt="법인/단체 대상 혜택"></h4>
							<ul class="list_opt">
								<li class="num2">
								...
								<li class="num5">
									<img src="http://socdnw.speedgabia.com/template/asset/images/company/reward.png" alt="법인별 맞춤 혜택 협의">
						...
						<div id="company2" class="content">
							<h3><img src="http://socdnw.speedgabia.com/template/asset/images/company/txt12.gif" alt="프로그램 이용방법"></h3>
							<p class="txt"><img src="http://socdnw.speedgabia.com/template/asset/images/company/guide.png" alt="쏘카 타면 일이 술술! 이제&nbsp;업무용 차량도 쏘카하세요. 사업자번호만 있으면 법인사업자 / 개인사업자 모두 법인회원으로 가입할 수 있습니다"></p>
							<div><a href="/join"><img alt="법인/단체 회원가입" src="http://socdnw.speedgabia.com/template/asset/images/company/btn_company_mail_n.gif"></a></div>
							<ol class="list_pro">
								<li>
									<strong class="tit"><img src="http://socdnw.speedgabia.com/template/asset/images/company/txt16.gif" alt="01. 법인/단체 가입 (관리자 계정)"></strong>
									<ol class="list">
								...
								<li class="r">
									<strong class="tit"><img src="http://socdnw.speedgabia.com/template/asset/images/company/txt17.gif" alt="02. 법인/단체 구성원 가입 (직원 계정)"></strong>
									<ol class="list">
							...
							<h4><img src="http://socdnw.speedgabia.com/template/asset/images/company/txt15.gif" alt=""></h4>
							<ul class="list_dot">
						...
						<div id="company3" class="content">
							<h3><img src="http://socdnw.speedgabia.com/template/asset/images/company/txt18.gif" alt="법인/단체 자주 묻는 질문"></h3>
							...
							<div class="qna_more"><img style="margin-bottom: 10px; margin-right: 10px;" src="http://socdnw.speedgabia.com/template/asset/images/company/more_question.png" alt="더 궁금한 사항이 있으시다면 고객센터 1:1 문의를 이용해 주세요."><a href="/inquiry" target="_blank"><img src="http://socdnw.speedgabia.com/template/asset/images/company/btn_question.png"></a></div>
						</div>
